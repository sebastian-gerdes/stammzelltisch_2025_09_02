...
## Approach
* Ordinary logistic regression performs quite bad due to collinearity
  * Risk of overfitting
* Remedy: penalty for large values for $\beta_j$
$$
Loss = NLL + Penalty
$$
NLL = negative log-likelihood --> corresponds to RSS (residual sum of squares)
...
* Penalization applies directly to the magnitude of the coefficients — and without standardization, variables on different scales are unfairly penalized
...
* Group lasso, Adaptive lasso, smoothly clipped absolute deviation (SCAD), Horseshoe prior and more
  * [Summary by ChatGPT](https://chatgpt.com/s/t_68ad955d84208191af66a07c8f631639)
